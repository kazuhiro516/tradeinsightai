      ...
      <div className="flex-1 overflow-y-auto p-2 sm:p-4 space-y-3 sm:space-y-4">
        {messages.map(message => (
          <div key={message.id} className={cn(
            "p-2 sm:p-3 rounded-lg max-w-[90%] sm:max-w-[80%]",
            message.role === 'user'
              ? 'bg-blue-100 ml-auto'
              : 'bg-white mr-auto'
          )}>
        ...
        {/* 入力中表示 */}
        {(isLoading || isTyping) && (
          <div className="p-2 sm:p-3 rounded-lg bg-white mr-auto max-w-[90%] sm:max-w-[80%]">
            <div className="font-bold mb-1 text-sm sm:text-base">AI:</div>
            <div className="animate-pulse text-sm sm:text-base">応答を生成中...</div>
          </div>
        )}

        {/* エラー表示 */}
        {error && (
          <div className="p-2 sm:p-3 rounded-lg bg-red-100 text-red-700 max-w-[90%] sm:max-w-[80%] mx-auto">
            <div className="font-bold mb-1 text-sm sm:text-base">エラー:</div>
      ...
      <div className="bg-white border-t p-2 sm:p-4">
        <form onSubmit={onSubmit} className="flex space-x-2">
          ...
          <button
            ...
            className="p-1.5 sm:p-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300"
          >
          ...
          <input
            ...
            className="flex-1 p-1.5 sm:p-2 text-sm sm:text-base border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <button
            ...
            className="p-1.5 sm:p-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
